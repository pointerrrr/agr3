...
namespace Template
{
	...
	public class OpenCLImage<T> where T : struct
	{
		...
		public OpenCLImage( OpenCLProgram ocl, int width, int height )
		{
			...
			{
				GL.TexImage2D( TextureTarget.Texture2D, 0, PixelInternalFormat.Rgba8, 512, 512, 0, OpenTK.Graphics.OpenGL.PixelFormat.Rgb, PixelType.Int, texData );
			}
	...
	public class OpenCLKernel
	{
		...
		public void SetArgument(int i, OpenCLBuffer<bool> v) { kernel.SetMemoryArgument(i, v._gpubuffer); }
